<div id="footer-lowlight"></div>

<footer id="main-footer">
  <div class="page-content-area">
    &copy; <?php echo date('Y'); ?> <a href="http://philparsons.co.uk">Phil Parsons</a> | 
    design <a href="http://twitter.com/karstenrowe">@karstenrowe</a>
  </div>
</footer>

<a id="fork-me" href="http://github.com/p-m-p">
